...
// override some values for multiplay.
	...
	// m249
	gSkillData.plrDmgM249 = 20;

	// knife
	gSkillData.plrDmgKnife = 25;

	// Sniper Round
	gSkillData.plrDmgM40a1 = 200;

	// Sporelauncher Spore
	gSkillData.plrDmgSpore = 100;

	// Shockrifle
	gSkillData.plrDmgShockm = 25;
	gSkillData.plrDmgShocks = 25;
...
#define MAX_MOTD_LENGTH   3584 // (MAX_MOTD_CHUNK * 4)
