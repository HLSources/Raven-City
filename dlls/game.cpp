...
// vortigaunt
cvar_t	sk_vortigaunt_health1 = {"sk_vortigaunt_health1","0"};
cvar_t	sk_vortigaunt_health2 = {"sk_vortigaunt_health2","0"};
cvar_t	sk_vortigaunt_health3 = {"sk_vortigaunt_health3","0"};

cvar_t	sk_vortigaunt_dmg_claw1 = {"sk_vortigaunt_dmg_claw1","0"};
cvar_t	sk_vortigaunt_dmg_claw2 = {"sk_vortigaunt_dmg_claw2","0"};
cvar_t	sk_vortigaunt_dmg_claw3 = {"sk_vortigaunt_dmg_claw3","0"};

cvar_t	sk_vortigaunt_dmg_clawrake1	= {"sk_vortigaunt_dmg_clawrake1","0"};
cvar_t	sk_vortigaunt_dmg_clawrake2	= {"sk_vortigaunt_dmg_clawrake2","0"};
cvar_t	sk_vortigaunt_dmg_clawrake3	= {"sk_vortigaunt_dmg_clawrake3","0"};
	
cvar_t	sk_vortigaunt_dmg_zap1 = {"sk_vortigaunt_dmg_zap1","0"};
cvar_t	sk_vortigaunt_dmg_zap2 = {"sk_vortigaunt_dmg_zap2","0"};
cvar_t	sk_vortigaunt_dmg_zap3 = {"sk_vortigaunt_dmg_zap3","0"};
...
// harrison
cvar_t	sk_harrison_health1	= {"sk_harrison_health1","0"};
cvar_t	sk_harrison_health2	= {"sk_harrison_health2","0"};
cvar_t	sk_harrison_health3	= {"sk_harrison_health3","0"};

cvar_t	sk_harrison_kick1	= {"sk_harrison_kick1","0"};
cvar_t	sk_harrison_kick2	= {"sk_harrison_kick2","0"};
cvar_t	sk_harrison_kick3	= {"sk_harrison_kick3","0"};
...
// spec ops grunt 
cvar_t	sk_spec_ops_health1 = {"sk_spec_ops_health1","0"};
cvar_t	sk_spec_ops_health2 = {"sk_spec_ops_health2","0"};
cvar_t	sk_spec_ops_health3 = {"sk_spec_ops_health3","0"};

cvar_t	sk_spec_ops_kick1 = {"sk_spec_ops_kick1","0"};
cvar_t	sk_spec_ops_kick2 = {"sk_spec_ops_kick2","0"};
cvar_t	sk_spec_ops_kick3 = {"sk_spec_ops_kick3","0"};

cvar_t	sk_spec_ops_pellets1 = {"sk_spec_ops_pellets1","0"};
cvar_t	sk_spec_ops_pellets2 = {"sk_spec_ops_pellets2","0"};
cvar_t	sk_spec_ops_pellets3 = {"sk_spec_ops_pellets3","0"};

cvar_t	sk_spec_ops_gspeed1 = {"sk_spec_ops_gspeed1","0"};
cvar_t	sk_spec_ops_gspeed2 = {"sk_spec_ops_gspeed2","0"};
cvar_t	sk_spec_ops_gspeed3 = {"sk_spec_ops_gspeed3","0"};
...
// Maria
cvar_t	sk_maria_health1	= {"sk_maria_health1","0"};
cvar_t	sk_maria_health2	= {"sk_maria_health2","0"};
cvar_t	sk_maria_health3	= {"sk_maria_health3","0"};
...
cvar_t	sk_boris_kick1 = {"sk_boris_kick1","0"};
cvar_t	sk_boris_kick2 = {"sk_boris_kick2","0"};
cvar_t	sk_boris_kick3 = {"sk_boris_kick3","0"};

cvar_t	sk_boris_pellets1 = {"sk_boris_pellets1","0"};
cvar_t	sk_boris_pellets2 = {"sk_boris_pellets2","0"};
cvar_t	sk_boris_pellets3 = {"sk_boris_pellets3","0"};

cvar_t	sk_boris_zap1 = {"sk_boris_zap1","0"};
cvar_t	sk_boris_zap2 = {"sk_boris_zap2","0"};
cvar_t	sk_boris_zap3 = {"sk_boris_zap3","0"};

// Hgrunt 
cvar_t	sk_super_zombie_health1 = {"sk_super_zombie_health1","0"};
cvar_t	sk_super_zombie_health2 = {"sk_super_zombie_health2","0"};
cvar_t	sk_super_zombie_health3 = {"sk_super_zombie_health3","0"};

cvar_t	sk_super_zombie_stab1 = {"sk_super_zombie_stab1","0"};
cvar_t	sk_super_zombie_stab2 = {"sk_super_zombie_stab2","0"};
cvar_t	sk_super_zombie_stab3 = {"sk_super_zombie_stab3","0"};

cvar_t	sk_super_zombie_pellets1 = {"sk_super_zombie_pellets1","0"};
cvar_t	sk_super_zombie_pellets2 = {"sk_super_zombie_pellets2","0"};
cvar_t	sk_super_zombie_pellets3 = {"sk_super_zombie_pellets3","0"};
...
cvar_t	sk_gangster_gspeed1 = {"sk_gangster_gspeed1","0"};
cvar_t	sk_gangster_gspeed2 = {"sk_gangster_gspeed2","0"};
cvar_t	sk_gangster_gspeed3 = {"sk_gangster_gspeed3","0"};
...
// M203 grenade
cvar_t	sk_plr_m4a1_grenade1 = {"sk_plr_m4a1_grenade1","0"};
cvar_t	sk_plr_m4a1_grenade2 = {"sk_plr_m4a1_grenade2","0"};
cvar_t	sk_plr_m4a1_grenade3 = {"sk_plr_m4a1_grenade3","0"};
...
cvar_t	sk_m4a1_bullet1 = {"sk_m4a1_bullet1","0"};
cvar_t	sk_m4a1_bullet2 = {"sk_m4a1_bullet2","0"};
cvar_t	sk_m4a1_bullet3 = {"sk_m4a1_bullet3","0"};
...
cvar_t	sk_beretta_bullet1 = {"sk_beretta_bullet1","0"};
cvar_t	sk_beretta_bullet2 = {"sk_beretta_bullet2","0"};
cvar_t	sk_beretta_bullet3 = {"sk_beretta_bullet3","0"};
...
// REGISTER CVARS FOR SKILL LEVEL STUFF
	...
	// Boris
	CVAR_REGISTER ( &sk_boris_health1 );// {"sk_hgrunt_health1","0"};
	CVAR_REGISTER ( &sk_boris_health2 );// {"sk_hgrunt_health2","0"};
	CVAR_REGISTER ( &sk_boris_health3 );// {"sk_hgrunt_health3","0"};

	CVAR_REGISTER ( &sk_boris_kick1 );// {"sk_hgrunt_kick1","0"};
	CVAR_REGISTER ( &sk_boris_kick2 );// {"sk_hgrunt_kick2","0"};
	CVAR_REGISTER ( &sk_boris_kick3 );// {"sk_hgrunt_kick3","0"};

	CVAR_REGISTER ( &sk_boris_pellets1 );
	CVAR_REGISTER ( &sk_boris_pellets2 );
	CVAR_REGISTER ( &sk_boris_pellets3 );

	CVAR_REGISTER ( &sk_boris_zap1 );
	CVAR_REGISTER ( &sk_boris_zap2 );
	CVAR_REGISTER ( &sk_boris_zap3 );
	...
	// Harrison
	CVAR_REGISTER ( &sk_harrison_health1 );
	CVAR_REGISTER ( &sk_harrison_health2 );
	CVAR_REGISTER ( &sk_harrison_health3 );

	CVAR_REGISTER ( &sk_harrison_kick1 );
	CVAR_REGISTER ( &sk_harrison_kick2 );
	CVAR_REGISTER ( &sk_harrison_kick3 );
	...
	// torch 
	CVAR_REGISTER ( &sk_torch_ally_health1 );// {"sk_hgrunt_health1","0"};
	CVAR_REGISTER ( &sk_torch_ally_health2 );// {"sk_hgrunt_health2","0"};
	CVAR_REGISTER ( &sk_torch_ally_health3 );// {"sk_hgrunt_health3","0"};

	CVAR_REGISTER ( &sk_torch_ally_kick1 );// {"sk_hgrunt_kick1","0"};
	CVAR_REGISTER ( &sk_torch_ally_kick2 );// {"sk_hgrunt_kick2","0"};
	CVAR_REGISTER ( &sk_torch_ally_kick3 );// {"sk_hgrunt_kick3","0"};

	// medic
	CVAR_REGISTER ( &sk_medic_ally_health1 );// {"sk_hgrunt_health1","0"};
	CVAR_REGISTER ( &sk_medic_ally_health2 );// {"sk_hgrunt_health2","0"};
	CVAR_REGISTER ( &sk_medic_ally_health3 );// {"sk_hgrunt_health3","0"};

	CVAR_REGISTER ( &sk_medic_ally_kick1 );// {"sk_hgrunt_kick1","0"};
	CVAR_REGISTER ( &sk_medic_ally_kick2 );// {"sk_hgrunt_kick2","0"};
	CVAR_REGISTER ( &sk_medic_ally_kick3 );// {"sk_hgrunt_kick3","0"};

	CVAR_REGISTER ( &sk_medic_ally_heal1 );// {"sk_hgrunt_kick1","0"};
	CVAR_REGISTER ( &sk_medic_ally_heal2 );// {"sk_hgrunt_kick2","0"};
	CVAR_REGISTER ( &sk_medic_ally_heal3 );// {"sk_hgrunt_kick3","0"};

	// ally grunt
	CVAR_REGISTER ( &sk_spec_ops_health1 );
	CVAR_REGISTER ( &sk_spec_ops_health2 );
	CVAR_REGISTER ( &sk_spec_ops_health3 );

	CVAR_REGISTER ( &sk_spec_ops_kick1 );
	CVAR_REGISTER ( &sk_spec_ops_kick2 );
	CVAR_REGISTER ( &sk_spec_ops_kick3 );

	CVAR_REGISTER ( &sk_spec_ops_pellets1 );
	CVAR_REGISTER ( &sk_spec_ops_pellets2 );
	CVAR_REGISTER ( &sk_spec_ops_pellets3 );

	CVAR_REGISTER ( &sk_spec_ops_gspeed1 );
	CVAR_REGISTER ( &sk_spec_ops_gspeed2 );
	CVAR_REGISTER ( &sk_spec_ops_gspeed3 );


	// Hassassin
	CVAR_REGISTER ( &sk_massassin_health1 );// {"sk_hgrunt_health1","0"};
	CVAR_REGISTER ( &sk_massassin_health2 );// {"sk_hgrunt_health2","0"};
	CVAR_REGISTER ( &sk_massassin_health3 );// {"sk_hgrunt_health3","0"};

	CVAR_REGISTER ( &sk_massassin_kick1 );// {"sk_hgrunt_kick1","0"};
	CVAR_REGISTER ( &sk_massassin_kick2 );// {"sk_hgrunt_kick2","0"};
	CVAR_REGISTER ( &sk_massassin_kick3 );// {"sk_hgrunt_kick3","0"};
	...
	// vortigaunt
	CVAR_REGISTER ( &sk_vortigaunt_health1 );// {"sk_vortigaunt_health1","0"};
	CVAR_REGISTER ( &sk_vortigaunt_health2 );// {"sk_vortigaunt_health2","0"};
	CVAR_REGISTER ( &sk_vortigaunt_health3 );// {"sk_vortigaunt_health3","0"};

	CVAR_REGISTER ( &sk_vortigaunt_dmg_claw1 );// {"sk_vortigaunt_dmg_claw1","0"};
	CVAR_REGISTER ( &sk_vortigaunt_dmg_claw2 );// {"sk_vortigaunt_dmg_claw2","0"};
	CVAR_REGISTER ( &sk_vortigaunt_dmg_claw3 );// {"sk_vortigaunt_dmg_claw3","0"};

	CVAR_REGISTER ( &sk_vortigaunt_dmg_clawrake1	);// {"sk_vortigaunt_dmg_clawrake1","0"};
	CVAR_REGISTER ( &sk_vortigaunt_dmg_clawrake2	);// {"sk_vortigaunt_dmg_clawrake2","0"};
	CVAR_REGISTER ( &sk_vortigaunt_dmg_clawrake3	);// {"sk_vortigaunt_dmg_clawrake3","0"};
		
	CVAR_REGISTER ( &sk_vortigaunt_dmg_zap1 );// {"sk_vortigaunt_dmg_zap1","0"};
	CVAR_REGISTER ( &sk_vortigaunt_dmg_zap2 );// {"sk_vortigaunt_dmg_zap2","0"};
	CVAR_REGISTER ( &sk_vortigaunt_dmg_zap3 );// {"sk_vortigaunt_dmg_zap3","0"};
	...
	// Kate
	CVAR_REGISTER ( &sk_maria_health1 );// {"sk_zombie_health1","0"};
	CVAR_REGISTER ( &sk_maria_health2 );// {"sk_zombie_health3","0"};
	CVAR_REGISTER ( &sk_maria_health3 );// {"sk_zombie_health3","0"};

	// Gonome
	CVAR_REGISTER ( &sk_gonome_health1 );// {"sk_zombie_health1","0"};
	CVAR_REGISTER ( &sk_gonome_health2 );// {"sk_zombie_health3","0"};
	CVAR_REGISTER ( &sk_gonome_health3 );// {"sk_zombie_health3","0"};

	CVAR_REGISTER ( &sk_gonome_dmg_one_slash1 );// {"sk_zombie_dmg_one_slash1","0"};
	CVAR_REGISTER ( &sk_gonome_dmg_one_slash2 );// {"sk_zombie_dmg_one_slash2","0"};
	CVAR_REGISTER ( &sk_gonome_dmg_one_slash3 );// {"sk_zombie_dmg_one_slash3","0"};

	CVAR_REGISTER ( &sk_gonome_dmg_guts1 );// {"sk_zombie_dmg_one_slash1","0"};
	CVAR_REGISTER ( &sk_gonome_dmg_guts2 );// {"sk_zombie_dmg_one_slash2","0"};
	CVAR_REGISTER ( &sk_gonome_dmg_guts3 );// {"sk_zombie_dmg_one_slash3","0"};

	CVAR_REGISTER ( &sk_gonome_dmg_one_bite1 );// {"sk_zombie_dmg_both_slash1","0"};
	CVAR_REGISTER ( &sk_gonome_dmg_one_bite2 );// {"sk_zombie_dmg_both_slash2","0"};
	CVAR_REGISTER ( &sk_gonome_dmg_one_bite3 );// {"sk_zombie_dmg_both_slash3","0"};

	// ally grunt
	CVAR_REGISTER ( &sk_super_zombie_health1 );
	CVAR_REGISTER ( &sk_super_zombie_health2 );
	CVAR_REGISTER ( &sk_super_zombie_health3 );

	CVAR_REGISTER ( &sk_super_zombie_stab1 );
	CVAR_REGISTER ( &sk_super_zombie_stab2 );
	CVAR_REGISTER ( &sk_super_zombie_stab3 );

	CVAR_REGISTER ( &sk_super_zombie_pellets1 );
	CVAR_REGISTER ( &sk_super_zombie_pellets2 );
	CVAR_REGISTER ( &sk_super_zombie_pellets3 );

	// ally grunt
	CVAR_REGISTER ( &sk_gangster_health1 );
	CVAR_REGISTER ( &sk_gangster_health2 );
	CVAR_REGISTER ( &sk_gangster_health3 );

	CVAR_REGISTER ( &sk_gangster_kick1 );
	CVAR_REGISTER ( &sk_gangster_kick2 );
	CVAR_REGISTER ( &sk_gangster_kick3 );

	CVAR_REGISTER ( &sk_gangster_pellets1 );
	CVAR_REGISTER ( &sk_gangster_pellets2 );
	CVAR_REGISTER ( &sk_gangster_pellets3 );

	CVAR_REGISTER ( &sk_gangster_gspeed1 );
	CVAR_REGISTER ( &sk_gangster_gspeed2 );
	CVAR_REGISTER ( &sk_gangster_gspeed3 );
	...
	// m4a1 Round
	CVAR_REGISTER ( &sk_plr_m4a1_bullet1 );// {"sk_plr_m4a1_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_m4a1_bullet2 );// {"sk_plr_m4a1_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_m4a1_bullet3 );// {"sk_plr_m4a1_bullet3","0"};

	// M203 grenade
	CVAR_REGISTER ( &sk_plr_m4a1_grenade1 );// {"sk_plr_m4a1_grenade1","0"};
	CVAR_REGISTER ( &sk_plr_m4a1_grenade2 );// {"sk_plr_m4a1_grenade2","0"};
	CVAR_REGISTER ( &sk_plr_m4a1_grenade3 );// {"sk_plr_m4a1_grenade3","0"};
	...
	// beretta
	CVAR_REGISTER ( &sk_plr_beretta1 );
	CVAR_REGISTER ( &sk_plr_beretta2 );
	CVAR_REGISTER ( &sk_plr_beretta3 );
	...
	CVAR_REGISTER ( &sk_m4a1_bullet1 );// {"sk_9mm_bullet1","0"};
	CVAR_REGISTER ( &sk_m4a1_bullet2 );// {"sk_9mm_bullet1","0"};
	CVAR_REGISTER ( &sk_m4a1_bullet3 );// {"sk_9mm_bullet1","0"};
	...
	// 357 Round
	CVAR_REGISTER ( &sk_357_bullet1 );
	CVAR_REGISTER ( &sk_357_bullet2 );
	CVAR_REGISTER ( &sk_357_bullet3 );

	// beretta
	CVAR_REGISTER ( &sk_beretta_bullet1 );
	CVAR_REGISTER ( &sk_beretta_bullet2 );
	CVAR_REGISTER ( &sk_beretta_bullet3 );
...
// END REGISTER CVARS FOR SKILL LEVEL STUFF
	...
	SERVER_COMMAND( "exec skillraven.cfg\n" );
}
