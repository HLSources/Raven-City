...
#define M4A1_MAX_CLIP			50
#define M4A1_DEFAULT_AMMO		25
...
#define BERETTA_MAX_CLIP		12

// the default amount of ammo that comes with each gun when it spawns
#define GLOCK_DEFAULT_GIVE			17
#define PYTHON_DEFAULT_GIVE			6
#define M4A1_DEFAULT_GIVE			25
#define M4A1_DEFAULT_AMMO			25
#define M4A1_M203_DEFAULT_GIVE		0
...
#define BERETTA_DEFAULT_GIVE		12

// The amount of ammo given to a player by an ammo item.
#define AMMO_URANIUMBOX_GIVE	20
#define AMMO_GLOCKCLIP_GIVE		GLOCK_MAX_CLIP
#define AMMO_357BOX_GIVE		PYTHON_MAX_CLIP
#define AMMO_M4A1CLIP_GIVE		M4A1_MAX_CLIP
...
public:
	...
	int m_iPlayDispEmptySound;
	int m_fFireOnEmpty;		// True when the gun is empty and the player is still holding down the
							// attack key(s)
	virtual BOOL PlayEmptySound( void );
	virtual void ResetEmptySound( void );
	virtual BOOL PlayDispEmptySound( void );
	virtual void ResetDispEmptySound( void );
	...
	int DefaultReload( int iClipSize, int iAnim, float fDelay, int body  = 0, int override = 0 );
...
public:
	...
	int m_iShell;
	int m_iMode;
	BOOL m_fFullReload; // The clip was dry when we began reloading, so pump when done.
	virtual BOOL UseDecrement( void )
	{ 
#if defined( CLIENT_WEAPONS )
		return TRUE;
...
private:
	...
	unsigned short m_usShotgunCock;
};
...
public:
	...
	void Precache( void );
	int iItemSlot( void ) { return 1; }
	void EXPORT Hit( void );
	int GetItemInfo(ItemInfo *p);
	void PlayTextureSound( CBaseEntity *pEntity, TraceResult tr, Vector vecSrc, Vector vecEnd );
