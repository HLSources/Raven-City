...
extern int g_teamplay, g_FogEndDist;
...
extern int gmsgInitHUD; //AJH - Killars MP3player
...
void ClientCommand( edict_t *pEntity )
{
	...
	else if ( FStrEq(pcmd, "addfog" ) )  //AJH - MP3/OGG player (based on killars MP3)
	{
		CClientFog *pFog = CClientFog::FogCreate();
		pFog->pev->rendercolor.x = 128;
		pFog->pev->rendercolor.y = 128;
		pFog->pev->rendercolor.z = 128;
		pFog->m_iEndDist = 1250;
		pFog->m_iStartDist = 1;
	...
	else if ( FStrEq(pcmd, "sunflare") ) //LRC - trigger entities manually
	{
	...
	// restart everything OGL related
	else if ( FStrEq(pcmd, "reinit_opengl" ) )
	{
...
void ClientPrecache( void )
{
	...
	PRECACHE_SOUND("common/vort_step1.wav");		// Vort walk on concrete
	PRECACHE_SOUND("common/vort_step2.wav");
	PRECACHE_SOUND("common/vort_step3.wav");
	PRECACHE_SOUND("common/vort_step4.wav");
	...
	PRECACHE_SOUND("impact/metal/metal_impact_bullet1.wav");
	PRECACHE_SOUND("impact/metal/metal_impact_bullet2.wav");

	PRECACHE_SOUND("impact/metal/vent_impact_bullet1.wav");
	PRECACHE_SOUND("impact/metal/vent_impact_bullet2.wav");
	PRECACHE_SOUND("impact/metal/vent_impact_bullet3.wav");

	PRECACHE_SOUND("impact/concrete/concrete_impact_bullet1.wav");
	PRECACHE_SOUND("impact/concrete/concrete_impact_bullet2.wav");
	PRECACHE_SOUND("impact/concrete/concrete_impact_bullet3.wav");
	PRECACHE_SOUND("impact/concrete/concrete_impact_bullet4.wav");

	PRECACHE_SOUND("impact/glass/glass_impact_bullet1.wav");
	PRECACHE_SOUND("impact/glass/glass_impact_bullet2.wav");
	PRECACHE_SOUND("impact/glass/glass_impact_bullet3.wav");
	PRECACHE_SOUND("impact/glass/glass_impact_bullet4.wav");

	PRECACHE_SOUND("impact/sand/sand_impact_bullet1.wav");
	PRECACHE_SOUND("impact/sand/sand_impact_bullet2.wav");
	PRECACHE_SOUND("impact/sand/sand_impact_bullet3.wav");
	PRECACHE_SOUND("impact/sand/sand_impact_bullet4.wav");

	PRECACHE_SOUND("impact/tile/tile_impact_bullet1.wav");
	PRECACHE_SOUND("impact/tile/tile_impact_bullet2.wav");
	PRECACHE_SOUND("impact/tile/tile_impact_bullet3.wav");
	PRECACHE_SOUND("impact/tile/tile_impact_bullet4.wav");

	PRECACHE_SOUND("impact/wood/wood_impact_bullet1.wav");
	PRECACHE_SOUND("impact/wood/wood_impact_bullet2.wav");
	PRECACHE_SOUND("impact/wood/wood_impact_bullet3.wav");
	PRECACHE_SOUND("impact/wood/wood_impact_bullet4.wav");
	PRECACHE_SOUND("impact/wood/wood_impact_bullet5.wav");

	PRECACHE_SOUND("weapons/ric_conc1.wav");
	PRECACHE_SOUND("weapons/ric_conc2.wav");
	...
	PRECACHE_SOUND("common/npc_tile1.wav");		// npc walk on tile
	PRECACHE_SOUND("common/npc_tile2.wav");
	PRECACHE_SOUND("common/npc_tile3.wav");
	PRECACHE_SOUND("common/npc_tile4.wav");
	PRECACHE_SOUND("common/npc_tile5.wav");
...
Returns the descriptive name of this .dll.  E.g., Raven City, or Team Fortress 2
===============
*/
...
void UpdateClientData ( const struct edict_s *ent, int sendweapons, struct clientdata_s *cd )
{
	...
	if ( sendweapons )
	{
		...
		if ( pl )
		{
			...
			cd->vuser1.x		= pl->ammo_556;
			cd->vuser1.x		= pl->ammo_762;
			cd->vuser1.x		= pl->ammo_spore;
			cd->vuser1.x		= pl->ammo_beretta;
			...
			if ( pl->m_pActiveItem )
			{
				...
				if ( gun && gun->UseDecrement() )
				{
					...
					//if ( pl->m_pActiveItem->m_iId == WEAPON_EAGLE )
					//{
					//	cd->vuser2.y = ( ( CDeagle * )pl->m_pActiveItem)->m_fEagleLaserActive;
					//}
				}
			}
		}
