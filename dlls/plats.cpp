...
//	pOther->TakeDamage(pev, pev, 1500, DMG_CRUSH);
...
class CFuncTrackAutoRC : public CFuncTrackAuto
{
public:
	void Use( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value );
	virtual void Blocked( CBaseEntity *pOther );
...
LINK_ENTITY_TO_CLASS( func_trackautochange_rc, CFuncTrackAutoRC );

void CFuncTrackAutoRC :: Use( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	CPathTrack *pTarget;
...
void CFuncTrackAutoRC :: Blocked( CBaseEntity *pOther )
{
	entvars_t*	pevToucher = pOther->pev;

	pOther->TakeDamage(pev, pevToucher, 1500, DMG_CRUSH);
}
// ----------------------------------------------------------
//
//
