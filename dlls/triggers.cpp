...
//===============================================
// TextWindow - I was unable to get it to send
// all the chunks, so the max limit is around
// 4096 bytes. Damn!
//===============================================
extern int gmsgTextWindow;
extern int gmsgServerName;

#define MAX_MOTD_CHUNK	  256
...
void CTextWindow::Use( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	...
	MESSAGE_BEGIN( MSG_ALL, gmsgTextWindow, NULL );
		WRITE_STRING( m_szTextFile );
	MESSAGE_END();
}
