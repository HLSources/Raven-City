...
#define CSENTENCEG_MAX 600					// max number of sentence groups
// globals
...
//	if (fTextureTypeInit)
	...
	strcpy( sz, "maps/");
	strcat( sz, STRING( gpGlobals->mapname ) );
	strcat( sz, "_materials.txt" );

	pMemFile = g_engfuncs.pfnLoadFileForMe( sz, &fileSize );
...
// hit the world, try to play sound based on texture material type
	...
	case CHAR_TEX_CONCRETE: fvol = 1.0; fvolbar = 0.9;
		rgsz[0] = "weapons/null.wav";
		cnt = 1;
		break;
	case CHAR_TEX_METAL: fvol = 0.9; fvolbar = 0.3;
		rgsz[0] = "weapons/ric_metal1.wav";
		rgsz[1] = "weapons/ric_metal2.wav";
		cnt = 2;
		break;
	...
	case CHAR_TEX_SLOSH: fvol = 0.9; fvolbar = 0.0;
		...
		cnt = 4;
		break;
	case CHAR_TEX_ORGANIC: fvol = 0.9; fvolbar = 0.0;
		rgsz[0] = "player/pl_organic1.wav";
		rgsz[1] = "player/pl_organic3.wav";
		rgsz[2] = "player/pl_organic2.wav";
		rgsz[3] = "player/pl_organic4.wav";
		cnt = 4;
		break;
	...
	case CHAR_TEX_FLESH:
		...
		cnt = 2;
		break;
	case CHAR_TEX_SNOW: fvol = 0.9; fvolbar = 0.0;
