...
extern DLL_GLOBAL	int		g_FogEndDist;
...
//=========================================================
// FootStep - My implementation of dynamic footsteps into
// the game, works with Steam and WON
//=========================================================
void CBaseMonster :: FootStep ( void )
{ 
	char chTextureType;
	float fvol;
	char szbuffer[64];
	...
	if ( pEntity )
		...
		pTextureName = TRACE_TEXTURE( ENT(0), pev->origin + Vector(0, 0, 8), pev->origin - Vector(0, 0, 16) );
	...
	if ( FClassnameIs( pev, "monster_male_assassin" ) )
	{
		switch( m_Activity )
		{
			case ACT_WALK:
	...
	if ( FClassnameIs( pev, "monster_vortigaunt_ally" )  )
	{
	...
	{
	case CHAR_TEX_METAL:
		if ( FClassnameIs( pev, "monster_maria" ) )
		{
			EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/maria_metal01.wav", fvol, ATTN_NORM, 0, PITCH_NORM);
		}
		else
		{
			switch (RANDOM_LONG(0,3))
			{
			case 0: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_metal1.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 1: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_metal2.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 2: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_metal3.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 3: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_metal4.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			}
		}
        break;
    case CHAR_TEX_DIRT:
		if ( FClassnameIs( pev, "monster_maria" ) )
		{
			EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/maria_dirt01.wav", fvol, ATTN_NORM, 0, PITCH_NORM);
		}
		else
		{
			switch (RANDOM_LONG(0,3))
			{
			case 0: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_dirt1.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 1: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_dirt2.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 2: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_dirt3.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 3: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_dirt4.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			}
		}
        break;
    case CHAR_TEX_VENT:
		...
		else
		{
			switch (RANDOM_LONG(0,3))
			{
			case 0: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_duct1.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 1: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_duct2.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 2: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_duct3.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 3: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_duct4.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			}
		}
        break;
    case CHAR_TEX_GRATE:
		if ( FClassnameIs( pev, "monster_maria" ) )
		{
			EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/maria_grate01.wav", fvol, ATTN_NORM, 0, PITCH_NORM);
		}
		else
		{
			switch (RANDOM_LONG(0,3))
			{
			case 0: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_grate1.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 1: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_grate2.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 2: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_grate3.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 3: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_grate4.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			}
		}
        break;
    case CHAR_TEX_ORGANIC:
		if ( FClassnameIs( pev, "monster_maria" ) )
		{
			EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/maria_organic01.wav", fvol, ATTN_NORM, 0, PITCH_NORM);
		}
		else
		{
			switch (RANDOM_LONG(0,3))
			{
			case 0: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_organic1.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 1: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_organic2.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 2: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_organic3.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 3: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_organic4.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			}
		}
        break;
    case CHAR_TEX_TILE:
		if ( FClassnameIs( pev, "monster_maria" ) )
		{
			EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/maria_tile01.wav", fvol, ATTN_NORM, 0, PITCH_NORM);
		}
		else if ( FClassnameIs( pev, "monster_human_grunt_ally" )  
			|| FClassnameIs( pev, "monster_human_torch_ally" ) 
			|| FClassnameIs( pev, "monster_human_medic_ally" ) 
			|| FClassnameIs( pev, "monster_zombie_soldier" ) )
		{
			switch (RANDOM_LONG(0,3))
			{
			case 0: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_tile1.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 1: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_tile2.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 2: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_tile3.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 3: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_tile4.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			}
		}
		else
		{
			...
			{
			case 0: EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/npc_tile1.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 1: EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/npc_tile2.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 2: EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/npc_tile3.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 3: EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/npc_tile4.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 4: EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/npc_tile5.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			}
		}
        break;
    ...
    case CHAR_TEX_SNOW:
		switch (RANDOM_LONG(0,3))
		{
		case 0: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_snow1.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
		case 1: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_snow2.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
		case 2: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_snow3.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
		case 3: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_snow4.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
		}
        break;
    case CHAR_TEX_WOOD:
		if ( FClassnameIs( pev, "monster_maria" ) )
		{
			EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/maria_wood01.wav", fvol, ATTN_NORM, 0, PITCH_NORM);
		}
		else
		{
			switch (RANDOM_LONG(0,3))
			{
			case 0: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_wood1.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 1: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_wood2.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 2: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_wood3.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 3: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_wood4.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			}
		}
        break;
    case CHAR_TEX_RUG:
		if ( FClassnameIs( pev, "monster_maria" ) )
		{
			EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/maria_rug01.wav", fvol, ATTN_NORM, 0, PITCH_NORM);
		}
		else
		{
			switch (RANDOM_LONG(0,3))
			{
			case 0: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_rug1.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 1: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_rug2.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 2: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_rug3.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 3: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_rug4.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			}
		}
        break;
    case CHAR_TEX_GRAVEL:
		if ( FClassnameIs( pev, "monster_maria" ) )
		{
			EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/maria_gravel01.wav", fvol, ATTN_NORM, 0, PITCH_NORM);
		}
		else
		{
			switch (RANDOM_LONG(0,3))
			{
			case 0: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_gravel1.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 1: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_gravel2.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 2: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_gravel3.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 3: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_gravel4.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			}
		}
        break;
	default:
		if ( FClassnameIs( pev, "monster_maria" ) )
		{
			EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/maria_step01.wav", fvol, ATTN_NORM, 0, PITCH_NORM);
		}
		else if ( FClassnameIs( pev, "monster_boris" ) )
		{
			EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_jump1.wav", fvol, ATTN_NORM, 0, PITCH_NORM);
		}
		else if ( FClassnameIs( pev, "monster_human_grunt_ally" )  
			|| FClassnameIs( pev, "monster_human_torch_ally" ) 
			|| FClassnameIs( pev, "monster_human_medic_ally" ) 
			|| FClassnameIs( pev, "monster_zombie_soldier" ) )
		{
			switch (RANDOM_LONG(0,3))
			{
			case 0: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_step1.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 1: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_step2.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 2: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_step3.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 3: EMIT_SOUND_DYN( edict(), CHAN_BODY, "player/pl_step4.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			}
		}
		else if ( FClassnameIs( pev, "monster_vortigaunt_ally" )  )
		{
			switch (RANDOM_LONG(0,3))
			{
			case 0: EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/vort_step1.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 1: EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/vort_step2.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 2: EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/vort_step3.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 3: EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/vort_step4.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			}
		}
		else if ( FClassnameIs( pev, "monster_superzombie" )  )
		{
			switch (RANDOM_LONG(0,1))
			{
			case 0: EMIT_SOUND_DYN( edict(), CHAN_BODY, "szombie/run1.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 1: EMIT_SOUND_DYN( edict(), CHAN_BODY, "szombie/run2.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			}
		}
		else
		{
			switch (RANDOM_LONG(0,3))
			{
			case 0: EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/npc_step1.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 1: EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/npc_step2.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 2: EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/npc_step3.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			case 3: EMIT_SOUND_DYN( edict(), CHAN_BODY, "common/npc_step4.wav", fvol, ATTN_NORM, 0, PITCH_NORM); break;
			}
		}
	}
}
...
void CBaseMonster :: MonsterThink ( void )
{
	...
	{
		m_flDistLook = g_FogEndDist;
		m_flDistTooFar = g_FogEndDist - 100;
	}
...
int CBaseMonster::IRelationship ( CBaseEntity *pTarget )
{
	...
	{			 //   NONE	 MACH	 PLYR	 HPASS	 HMIL	 AMIL	 APASS	 AMONST	APREY	 APRED	 INSECT	PLRALY	PBWPN	ABWPN	VORTALLY BORIS
	/*NONE*/		{ R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	},
	/*MACHINE*/		{ R_NO	,R_NO	,R_DL	,R_DL	,R_NO	,R_DL	,R_DL	,R_DL	,R_DL	,R_DL	,R_NO	,R_DL	,R_DL	,R_DL	,R_DL	,R_NO	},
	/*PLAYER*/		{ R_NO	,R_DL	,R_NO	,R_NO	,R_DL	,R_DL	,R_DL	,R_DL	,R_DL	,R_DL	,R_NO	,R_NO	,R_DL	,R_DL	,R_NO	,R_AL	},
	/*HUMANPASSIVE*/{ R_NO	,R_NO	,R_AL	,R_AL	,R_HT	,R_FR	,R_NO	,R_HT	,R_DL	,R_FR	,R_NO	,R_AL	,R_NO	,R_NO	,R_AL	,R_DL	},
	/*HUMANMILITAR*/{ R_NO	,R_NO	,R_HT	,R_DL	,R_NO	,R_HT	,R_DL	,R_DL	,R_DL	,R_DL	,R_NO	,R_HT	,R_NO	,R_NO	,R_HT	,R_NO	},
	/*ALIENMILITAR*/{ R_NO	,R_DL	,R_HT	,R_DL	,R_HT	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_DL	,R_NO	,R_NO	,R_DL	,R_DL	},
	/*ALIENPASSIVE*/{ R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	},
	/*ALIENMONSTER*/{ R_NO	,R_DL	,R_DL	,R_DL	,R_DL	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_DL	,R_NO	,R_NO	,R_DL	,R_DL	},
	/*ALIENPREY   */{ R_NO	,R_NO	,R_DL	,R_DL	,R_DL	,R_NO	,R_NO	,R_NO	,R_NO	,R_FR	,R_NO	,R_DL	,R_NO	,R_NO	,R_DL	,R_DL	},
	...
	/*PLAYERALLY*/	{ R_NO	,R_DL	,R_AL	,R_AL	,R_DL	,R_DL	,R_DL	,R_DL	,R_DL	,R_DL	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_DL	},
	...
	/*VORTALLY*/	{ R_NO	,R_DL	,R_AL	,R_AL	,R_DL	,R_DL	,R_DL	,R_DL	,R_DL	,R_DL	,R_NO	,R_NO	,R_NO	,R_NO	,R_NO	,R_DL	},
	/*BORIS*/		{ R_NO	,R_AL	,R_AL	,R_DL	,R_AL	,R_DL	,R_DL	,R_DL	,R_DL	,R_DL	,R_NO	,R_DL	,R_NO	,R_NO	,R_DL	,R_NO	}
	};
...
void CBaseMonster :: HandleAnimEvent( MonsterEvent_t *pEvent )
{
	...
	case SCRIPT_EVENT_SOUND:			// Play a named wave file
		if( FStrEq( pEvent->options, "common/npc_step1.wav" ) || FStrEq( pEvent->options, "common/npc_step2.wav" ) ||
			FStrEq( pEvent->options, "common/npc_step3.wav" ) || FStrEq( pEvent->options, "common/npc_step4.wav" )) 
			FootStep(); 
		else EMIT_SOUND( edict(), CHAN_BODY, pEvent->options, 1.0, ATTN_IDLE ); 
		break;

	case SCRIPT_EVENT_STEP:			// Play a named wave file
		FootStep();
		break;
...
void CBaseMonster::ReportAIState( void )
{
	...
	CProtagonistMonster *pProtagonistMonster = MyProtagonistMonsterPointer();
	if ( pSquadMonster )
	{
