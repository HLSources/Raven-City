...
const char WHITE_SMOKE_PARTICLE[MAX_PARTICLE_PATH] = "particles/smoke03.tga";
...
const unsigned int iDefaultHitSnow = 38;//when a bullet or something impacts it (blue)
const unsigned int iDefaultSporeExplosion = 39;//when a bullet or something impacts it (blue)
const unsigned int iDefaultHitDirt = 40;//when a bullet or something impacts it (blue)
const unsigned int iDefaultHitGravel = 41;//when a bullet or something impacts it (blue)
const unsigned int iDefaultHitGlass = 42;//when a bullet or something impacts it (blue)
const unsigned int iDefaultHitTile = 43;//when a bullet or something impacts it (blue)
