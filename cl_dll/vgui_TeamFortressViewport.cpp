...
//=========================================
// Customized text loader, to avoid crashes
// with bigger file sizes.
//=========================================
int TeamFortressViewport::MsgFunc_TextWindow( const char *pszName, int iSize, void *pbuf )
{
	if (m_iGotAllMOTD)
		m_szMOTD[0] = 0;
	...
	sprintf(pFile, READ_STRING());
	char *pText = (char*)gEngfuncs.COM_LoadFile( pFile, 5, NULL );

	if ( pText )
	{
		int roomInArray = sizeof(m_szMOTD) - strlen(m_szMOTD) - 1;

		strncat( m_szMOTD, pText, roomInArray >= 0 ? roomInArray : 0 );
		m_szMOTD[ sizeof(m_szMOTD)-1 ] = '\0';
