...
/*
=====================
CBasePlayerWeapon :: PlayDispEmptySound

=====================
*/
BOOL CBasePlayerWeapon :: PlayDispEmptySound( void )
{
	if (m_iPlayDispEmptySound)
	{
		HUD_PlaySound( "buttons/button11.wav", 0.8 );
...
/*
=====================
CBasePlayerWeapon :: ResetDispEmptySound
...
void CBasePlayerWeapon::SendWeaponAnim( int iAnim, int skiplocal, int body )
{
	...
	HUD_SendWeaponAnim( iAnim, body, 1 );
}
...
//		pCurrent->m_flPumpTime			= pfrom->m_flPumpTime;
	...
	player.ammo_556			= (int)from->client.vuser1[0];
	player.ammo_762			= (int)from->client.vuser1[0];
	player.ammo_spore		= (int)from->client.vuser1[0];
	...
	{
		( ( CDeagle * )player.m_pActiveItem)->m_fEagleLaserActive = (int)from->client.vuser2[ 1 ];
	}
	...
	to->client.vuser1[0]				= player.ammo_556;
	to->client.vuser1[0]				= player.ammo_762;
	to->client.vuser1[0]				= player.ammo_spore;
	...
	if ( player.m_pActiveItem->m_iId == WEAPON_EAGLE )
	{
		 from->client.vuser2[ 1 ] = ( ( CDeagle * )player.m_pActiveItem)->m_fEagleLaserActive;
	}
	...
	if ( g_runfuncs && ( HUD_GetWeaponAnim() != to->client.weaponanim ) )
	{
		...
		// Set the correct body for the m249
		if ( pWeapon == &g_M249 )
			 body = ( ( CM249 * )player.m_pActiveItem)->pev->body;
